...
# Fungsi untuk autentikasi password
def authenticate():
    password_placeholder = st.empty()
    password = password_placeholder.text_input("Masukkan Password:", type="password", key="password_input")
    return password == "password123"  # Ganti dengan password yang diinginkan

def main():
    st.title("Sistem Pengelolaan Data IPS")
    ...
    st.success("Password benar. Selamat datang!")
